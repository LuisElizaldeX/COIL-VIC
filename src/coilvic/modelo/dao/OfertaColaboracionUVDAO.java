...
public class OfertaColaboracionUVDAO {
    ...
    public static HashMap<String, Object> obtenerOfertasColaboracionUV() {
        ...
        if (conexionBD != null) {
            try {
                String consulta = "SELECT ocuv.idOfertaColaboracionUV, "
                        + "ocuv.descripcion, ocuv.nombre AS ofertaNombre, " 
                ...
                + "JOIN experienciaEducativa ee ON ocuv.idExperienciaEducativa = "
